...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print "The Gothons of Planet Percal",
        "#25 have invaded your ship and destroyed"
        print "your entire crew.",
        " You are the last surviving member and your last"
        print "mission is to get the neutron",
        " destruct bomb from the Weapons Armory,"
        print "put it in the bridge, & blow the ship up after getting into an"
        print "escape pod."
        print "\n"
        print "You're running down the central",
        " corridor to the Weapons Armory when"
        print "a Gothon jumps out, red scaly skin, ",
        "dark grimy teeth, and evil clown costume"
        print "flowing around his hate filled body. ",
        ...
        if action == "shoot!":
            ...
            " which throws"
            print "off your aim.  Your laser hits his costume but misses",
            " him entirely.  This"
            print "completely ruins his brand new costume",
            " his mother bought him, which"
            ...
            print "You wake up shortly after only to ",
            "die as the Gothon stomps on"
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        print "neutron bomb in its container. ",
        "There's a keypad lock on the box"
...
# In this exercise we've learned the process
# to use when to build something using Python
# with object-oriented programming. Also the use
# of OOPs concept.
